...
if(isset($_POST['submit'])){
  ...
  if(mysqli_num_rows($res)>0){
    ...
    if($pass != $rpass){
      ...
      $insert = "INSERT INTO fundis(name,email,phone,location,password)VALUES('$username','$email','$phone','$loc','$pass')";
  ...
  <main>
    <div class="container">
        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <h3 class="text-center">Fundi Registration</h3>
              <div class="card mb-3">
      ...
      ?>
                    ...
                    <div class="col-12">
                      <label for="yourPassword" class="form-label">Phone Number</label>
                    ...
                    <div class="col-12">
                      <p class="small mb-0"><a href="confirm.php">choose other</a></p>
                    </div>
