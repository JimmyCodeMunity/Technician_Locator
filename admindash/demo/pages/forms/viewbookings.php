            ...
            <div class="mdc-layout-grid__inner">
              ...
              <tr style="background-color:white; font-size: 14px;">
                 ...
                 <td>
                   <?php
                if($row['status']==1){
                  echo "<a class='btn btn-sm btn-success' href='?type=status&operation=deactive&id=".$row['id']."'>Unserved</a>&nbsp;";
                }else{
                  echo "<a class='btn btn-sm btn-danger' href='?type=status&operation=active&id=".$row['id']."'>served</a>&nbsp;";
                }
                ?>
              </td>
              <td>
