...
if(isset($_POST['update'])){
  ...
  $update_data = "UPDATE fundis SET name='$username',email='$email',mobile='$phone' WHERE id='$id'";
...
if(isset($_POST['passchange'])){
  ...
  $passchange = "UPDATE fundis SET password='$newpass' WHERE id='$id'";
...
$sql="SELECT * FROM fundis WHERE name='$username'";
            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell--span-12">
                ...
                <div class="mdc-card">
                  ...
                  <img src="../forms/images/<?=$row['userimage']; ?>" alt="dp" class="img-a img-fluid" style="border-radius: 50%;" width='100px' height='100px'>
                    ...
                    <div class="mdc-layout-grid__inner">
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--with-leading-icon">
                          ...
                          <input class="mdc-text-field__input" id="text-field-hero-input" value="<?php echo $row['name']; ?>">
                          <div class="mdc-line-ripple"></div>
                      ...
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon">
                          ...
                          <input class="mdc-text-field__input" id="text-field-hero-input" value="<?php echo $row['email']; ?>">
                          <div class="mdc-notched-outline">
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
