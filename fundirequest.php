...
<body class="text-center">
  <h1 class="welc">Hi, <span><?php echo $_SESSION['fundi_name']; ?></span></h1>
  <br>
  <h5>Click the button below to complete signup</h5>
  <a href="reqf_complete.php" class="btn btn-primary btn-lg btn-get-started btn-rounded scrollto">Continue</a>
   <br>
  <br>
  <br>
  <h3><strong>-We are here to offer all the services to you-</strong></h3>
</body>
