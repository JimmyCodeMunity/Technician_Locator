...
if(isset($_POST['saveimage'])){
  ...
  $update_data = "UPDATE fundis SET userimage='$profile_pic' WHERE id='$logid' ";
                    ...
                    <div class="mdc-layout-grid__inner">
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--with-leading-icon">
                          ...
                          <input class="mdc-text-field__input" id="text-field-hero-input" value="<?php echo $_SESSION['fundi_name']; ?>">
                          <div class="mdc-line-ripple"></div>
                      ...
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon">
                          ...
                          <input class="mdc-text-field__input" id="text-field-hero-input" value="<?php echo $_SESSION['fundi_email']; ?>">
                          <div class="mdc-notched-outline">
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
                      ...
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon">
                          <i class="material-icons mdc-text-field__icon">public</i>
                          <input class="mdc-text-field__input" id="text-field-hero-input" value="<?php echo $row['regnumber']; ?>">
                          <div class="mdc-notched-outline">
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
                      ...
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-trailing-icon">
                          ...
                          <input class="mdc-text-field__input" id="text-field-hero-input" value="<?php echo $row['experience'] ?> years">
                          <div class="mdc-notched-outline">
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
