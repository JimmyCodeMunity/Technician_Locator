...
if(isset($_GET['type']) && $_GET['type']!=''){
  ...
  if($type=='status'){
    ...
    $update_status_sql="update fundis set status='$status' where id='$id'";
...
$sql="SELECT * FROM fundis";
$res=mysqli_query($conn,$sql);


//booking counter
$book = "SELECT count(*) FROM bookings WHERE fundiname = '{$_SESSION['fundi_name']}'";
            ...
            <div class="mdc-layout-grid__inner">
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                <div class="mdc-card p-0">
                  <h6 class="card-title card-padding pb-0">Fundis</h6>
              ...
              <tr style="background-color:white; font-size: 14px;">
                 ...
                 <td><img src="../forms/images/<?=$row['userimage']; ?>" style="border-radius: 50%;width: 25px;height: 25px;" alt="user" class="user"></td>
                 ...
                 <td>
                   <?php
                if($row['status']==1){
                  echo "<a class='btn btn-sm btn-success' href='?type=status&operation=deactive&id=".$row['id']."'>Available</a>&nbsp;";
                }else{
                  echo "<a class='btn btn-sm btn-danger' href='?type=status&operation=active&id=".$row['id']."'>Unavailable</a>&nbsp;";
                }
                ?>
              </td>
              <td>
                <?php
                echo "<a class='btn btn-sm btn-primary' href='editfundi.php?id=".$row['id']."'>Edit</a>&nbsp;";
          ...
          <div class="mdc-layout-grid">
            <div class="mdc-layout-grid__inner">
              ...
              <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop d-flex justify-content-end">
                <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center tx-14">Free <a href="https://www.bootstrapdash.com/material-design-dashboard/" target="_blank"> material fundi </a> dashboards from Bootstrapdash.com</span>
              </div>
            </div>
          </div>
        </footer>
