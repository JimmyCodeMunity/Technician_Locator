...
$collect = "SELECT * FROM clients WHERE id ='$logid'";
...
if(isset($_POST['saveimage'])){
  ...
  $update_data = "UPDATE clients SET userimage='$profile_pic' WHERE id='$logid' ";
  ...
  <div class="body-wrapper">
    ...
    <aside class="mdc-drawer mdc-drawer--dismissible mdc-drawer--open">
      ...
      <div class="mdc-drawer__content">
        <div class="user-info">
          <p class="name"><?php echo $_SESSION['client_name'] ?></p>
          <p class="email"><?php echo $_SESSION['client_email'] ?></p>
        </div>
            ...
            <div class="mdc-list-item mdc-drawer-item">
              ...
              <div class="mdc-expansion-panel" id="ui-sub-menu">
                <nav class="mdc-list mdc-drawer-submenu">
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="../../pages/forms/viewuser.php">
                      Details
                    </a>
                  </div>
                  <div class="mdc-list-item mdc-drawer-item">
                    <a class="mdc-drawer-link" href="../../pages/forms/updateuser.php">
                      Update
                    </a>
                  </div>
                </nav>
      ...
      <header class="mdc-top-app-bar">
        <div class="mdc-top-app-bar__row">
          <div class="mdc-top-app-bar__section mdc-top-app-bar__section--align-start">
            ...
            <span class="mdc-top-app-bar__title">Greetings <?php echo $_SESSION['client_name'] ?></span>
                    ...
                    <div class="mdc-layout-grid__inner">
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--with-leading-icon">
                          ...
                          <input class="mdc-text-field__input" id="text-field-hero-input" value="<?php echo $_SESSION['client_name']; ?>">
                          <div class="mdc-line-ripple"></div>
                      ...
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon">
                          ...
                          <input class="mdc-text-field__input" id="text-field-hero-input" value="<?php echo $_SESSION['client_email']; ?>">
                          <div class="mdc-notched-outline">
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
                      ...
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop">
                        <div class="mdc-text-field mdc-text-field--outlined mdc-text-field--with-leading-icon">
                          ...
                          <input class="mdc-text-field__input" id="text-field-hero-input" value="<?php echo $_SESSION['client_reg']; ?>">
                          <div class="mdc-notched-outline">
                            <div class="mdc-notched-outline__leading"></div>
                            <div class="mdc-notched-outline__notch">
