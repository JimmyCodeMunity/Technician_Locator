...
if(isset($_POST['submit'])){
  ...
  if(mysqli_num_rows($res)>0){
    ...
    if($pass != $rpass){
      ...
      $insert = "INSERT INTO userdata(role,name,email,phone,location,password)VALUES('$userole','$username','$email','$phone','$loc','$pass')";
    ...
    <div class="container">
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              src="assets/img/toplog.png" alt="logo">
                    ...
                    <p class="text-center small">Enter your Details below</p>
                  </div>
      ...
      ?>
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="location" class="form-control" id="yourPassword" required>
                    ...
                    <div class="form-group">
                      ...
                      <select name="userole" class="form-control" id="exampleFormControlSelect1">
                        <?php
                        $role = "SELECT * FROM roles";
                        $rol = mysqli_query($conn,$role);

                         while($row = mysqli_fetch_assoc($rol)) { ?>
                          <option name="" value=""><?php echo $row['role']; ?></option>
                          <?php } ?>
                          </select>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Already have account? <a href="login.php">Back to login</a></p>
                    </div>
                  </form>
              ...
              <div class="credits">
                ...
                Designed by <a href="index.html">Fundis</a>
              </div>
