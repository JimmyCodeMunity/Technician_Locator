...
<body class="text-center">
  <h1 class="welc">Hi, <span><?php echo $_SESSION['client_name']; ?></span></h1>
  <br>
  <h5>Click the button below to complete signup</h5>
  <a href="completeSU.php" class="btn btn-primary btn-lg btn-get-started btn-rounded scrollto">Continue</a>
   <br>
  <br>
  <br>
